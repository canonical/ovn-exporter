...
require (
	...
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20250221051132-db7072290a78
...
replace (
	...
	github.com/ovn-org/ovn-kubernetes/go-controller => github.com/jneo8/ovn-kubernetes/go-controller v0.0.0-20251002012012-f15d9699a9e3
)
