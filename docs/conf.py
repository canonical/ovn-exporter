...
copyright = "%s AGPLv3, %s" % (datetime.date.today().year, author)
...
html_context = {
    ...
    "product_page": "github.com/canonical/ovn-exporter",
    ...
    "github_url": "https://github.com/canonical/ovn-exporter",
...
html_baseurl = 'https://canonical-ovn-exporter.readthedocs-hosted.com/'
